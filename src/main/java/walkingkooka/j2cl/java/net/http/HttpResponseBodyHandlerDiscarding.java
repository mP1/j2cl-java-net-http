...
final class HttpResponseBodyHandlerDiscarding extends HttpResponseBodyHandler<Void> {
     ...
     * Singleton
     */
    final static HttpResponseBodyHandlerDiscarding INSTANCE = new HttpResponseBodyHandlerDiscarding();

    private HttpResponseBodyHandlerDiscarding() {
        super();
    }

    @Override
    BodySubscriber<Void> apply0(ResponseInfo responseInfo) {
        return BodySubscribers.discarding();
    }

    @Override
    public String toString() {
        return "HttpResponse.discarding";
    }
}
